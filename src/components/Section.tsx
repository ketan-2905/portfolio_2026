...
// import { motion, useInView } from "framer-motion";
// import { cn } from "../utils";
// import { useIsMobile } from "../hook/useIsMobile"; // Import this hook
...
//   // Only use the intersection observer if we are on Desktop
//   const isInView = useInView(ref, { once: true, margin: "-100px" });
...
//       ref={ref}
//       // LOGIC FIX:
//       // On Mobile: Start Visible (opacity 1, y 0).
//       // On Desktop: Start Invisible (opacity 0, y 40).
//       initial={isMobile ? { opacity: 1, y: 0 } : { opacity: 0, y: 40 }}
      
//       // LOGIC FIX:
//       // On Mobile: Stay Visible.
//       // On Desktop: Animate when in view.
