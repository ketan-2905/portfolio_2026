...
//     title: "Fincognia — Autonomous Agentic Finance",
//     desc: "An AI-driven financial co-pilot for gig workers that predicts liquidity risks with 85% accuracy, autonomously prevents EMI defaults, optimizes insurance and tax workflows, and enables real-time credit simulations to ensure long-term financial solvency.",
//     tech: ["Machine Learning", "Agentic AI", "Generative AI", "Financial Modeling", "Predictive Analytics"],
//     side: "left",
//     imagesrc: "/project/fincogina.png",
//     demolink: "https://fincogina.vercel.app/",
//   },
//   {
//     title: "CyberSecure — AI-Powered Network Intrusion Detection",
//     desc: "An end-to-end AI-powered NIDS achieving 98% attack detection accuracy using XGBoost, explainable AI (SHAP), and blockchain-backed threat integrity via Merkle Trees.",
//     tech: ["Next.js", "TypeScript", "Python", "XGBoost", "Blockchain"],
//     side: "right",
//     imagesrc: "/project/cyberSecure.png",
//     demolink: "https://redact-cybersecure-tau.vercel.app/",
//   },
...
//     award: "Winner (Innovation Track)",
//     date: "DEC 2025",
//     desc: "Built Fincognia, an autonomous agentic finance co-pilot for gig workers.",
//   },
// ];
...
//   {
//     title: "DJS Nova Official",
//     description: "Designed and developed the official landing page for the college astronomy club.",
//     link: "https://djsnovaspace.vercel.app",
//     tags: ["Landing Page", "Next.js", "3D Experience"],
//     id: "NOVA_01",
//   },
//   {
//     title: "Moon Gazing Showcase",
//     description: "Built a visually engaging landing page for the 'Moon Gazing' event.",
//     link: "https://moongazing.vercel.app",
//     tags: ["Event Showcase", "UI/UX", "Responsive Design"],
//     id: "MOON_02",
//   },
...
// const ContactData = [
//   { icon: <Mail />, label: "Email", href: "mailto:ketangaikwad2905@gmail.com" },
...
//   // New State: Track if we are deep in the page
//   const [isHeroVisible, setIsHeroVisible] = useState(true);

//   useEffect(() => {
//     const handleScroll = () => {
//       // If we scroll past 120vh, turn off the 3D model completely
...
//   return (
//     <main className="relative bg-[#080808] text-gray-200 selection:bg-green-500/40 font-sans">
//       <AnimatePresence>
//         {isLoading && <LoadingScreen onFinished={() => setIsLoading(false)} />}
//       </AnimatePresence>
//       <Navbar />
...
//           Logic: If isHeroVisible is false, we set 'hidden'.
//           This physically unmounts the rendering layer from the screen.
//       */}
//       <div 
//         className={`fixed inset-0 z-0 top-0 left-0 w-full h-full pointer-events-none transition-opacity duration-500 ${isHeroVisible ? 'opacity-100 visible' : 'opacity-0 invisible'}`}
//       >
//           <div className="w-full h-full pointer-events-auto">
//              {/* Only render the Canvas if not loading (optional optimization) */}
//              {!isLoading && (
//                <HeoricSection
//                   letterStyles={letterStyles}
//                   handleScrollDown={handleScrollDown}
...
//       {/* 2. SPACER */}
//       <div className="relative z-10 w-full h-screen bg-transparent pointer-events-none" />

//       {/* 3. MAIN CONTENT */}
//       {/* Added 'will-change-transform' to hint browser to optimize painting */}
//       <div className="relative z-20 w-full bg-[#080808] rounded-t-[40px] border-t border-white/10 shadow-[0_-20px_60px_rgba(0,0,0,0.9)] will-change-transform">
        
//         <div className="absolute top-4 left-1/2 -translate-x-1/2 w-20 h-1.5 bg-white/10 rounded-full" />

//         <div className="max-w-6xl mx-auto px-6 pt-20 pb-1">
//           <Section id="about" title="Whomai" icon={<Terminal />}>
//             <AboutMe />
//           </Section>
